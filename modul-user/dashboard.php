            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalRegister"><i class="fa-sharp fa-solid fa-user-plus"></i> tambah data</button>
                        ...
                        <table class="table table-responsive">
                            ...
                            <tbody>
                                ...
                                while ($r = mysqli_fetch_object($d)) {
                                    ...
                                    echo '<td><a href="#" type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#myModal' . $r->id_user . '"><i class="fa-sharp fa-solid fa-pen-to-square"></i> Edit</a></td>';
                                    echo '<td><form action="" method="post"><input name="id_user" type="hidden" value=' . $r->id_user . '><button type="submit" class="btn btn-danger"><i class="fa-sharp fa-solid fa-trash"></i> hapus</form></td>';
                                    echo '<td></td></tr>';
